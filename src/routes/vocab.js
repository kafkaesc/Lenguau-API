...
router.get('/', (req, res) => {
	res.json({
		categoryList: [
			...
			{ en: 'Food', es: 'La Comida', kebab: 'Food' },
...
router.get('/:category', parseCategory, (req, res) => {
	switch (req.params.category) {
		...
		case 'food':
			res.json({
				title: { en: 'Food', es: 'La Comida' },
				vocabList: [
					{ en: 'apple', es: 'la manzana' },
					{ en: 'avocado', es: 'el aguacate' },
					...
					{ en: 'celery', es: 'el apio' },
					{ en: 'cheese', es: 'el queso' },
					{ en: 'chicken', es: 'el pollo' },
					{ en: 'cilantro', es: 'el cilantro' },
					{ en: 'coffee', es: 'el café' },
					{ en: 'cookie', es: 'la galleta' },
					{ en: 'corn', es: 'la maíz' },
					{ en: 'cream', es: 'la crema' },
					{ en: 'cucumber', es: 'el pepino' },
					{ en: 'egg', es: 'el huevo' },
					{ en: 'fish', es: 'el pescado' },
					{ en: 'food', es: 'la comida' },
					{ en: 'fruit', es: 'la fruta' },
					{ en: 'grape', es: 'la uva' },
					{ en: 'ham', es: 'el jamón' },
					{ en: 'ice', es: 'el hielo' },
					{ en: 'ice cream', es: 'el helado' },
					{ en: 'juice', es: 'el jugo' },
					{ en: 'lettuce', es: 'la lechuga' },
					{ en: 'meat', es: 'la carne' },
					{ en: 'milk', es: 'la leche' },
					{ en: 'mushroom', es: 'el champiñon' },
					{ en: 'onion', es: 'la cebolla' },
					{ en: 'orange', es: 'la naranja' },
					{ en: '(black) pepper', es: 'la pimienta' },
					{ en: '(chili) pepper', es: 'el chile' },
					{ en: 'plantain', es: 'el plátano' },
					{ en: 'pork', es: 'el cerdo' },
					{ en: 'potato', es: 'la papa' },
					{ en: 'rice', es: 'el arroz' },
					{ en: 'salad', es: 'la ensalada' },
					{ en: 'salt', es: 'la sal' },
					{ en: 'sauce', es: 'la salsa' },
					{ en: 'shrimp', es: 'el camarón' },
					{ en: 'soup', es: 'la sopa' },
					{ en: 'spinach', es: 'la espinaca' },
					{ en: 'steak', es: 'el bistec' },
					{ en: 'strawberry', es: 'la fresa' },
					{ en: 'sugar', es: 'el azúcar' },
					{ en: 'tomato', es: 'el tomate' },
					{ en: 'tuna', es: 'el atún' },
					{ en: 'turkey', es: 'el pavo' },
					{ en: 'vegetable', es: 'el vegetal, la verdura' },
					{ en: 'water', es: 'el agua' },
				],
			});
			break;
